...
import bgimg from '../assets/img/offer/bg-img.jpg';
import bgsub from '../assets/img/Mens/bg-sub-1.jpg';
import { Link } from 'react-router-dom';
function Offerspage() {
    return (
        <div className='offerspage watch-box border-t-[1px] border-[#12121214]'>
            <div className='nav-route flex px-[40px] gap-[7px] border-b-[1px] border-[#12121214] items-center py-[10px] text-[1.025vw] font-Zodiak-Regular text-[#121212bf]'>
                <Link to="/" >Home</Link>
                <i class="text-[6px] fa-solid fa-angle-right"></i>
                <Link to="/offerspage" className='hover:underline '>Exclusive Watch Offers</Link>
            </div>
            ...
            <div className='container mx-auto py-[35px]'>
                <div className='gap-[10px] mx-auto flex flex-wrap justify-center'>
                    {data.offerwatch.map((item, ind) => {
                        return (
                            <div key={ind} className='main-wrp mb-[1.5%]'>
                                <div className='offerspage-main watch-main'>
                                    <div className='relative rounded-lg overflow-hidden'>
                                        <div className='offerspage-img watch-img w-full h-full'>
