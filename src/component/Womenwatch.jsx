...
import bgimg from '../assets/img/womens/bg-img.jpg';
import bgsub from '../assets/img/womens/bg-sub-1.jpg';
import { Link } from 'react-router-dom';
function Womenwatch() {
    return (
        <div className='womenwatch watch-box border-t-[1px] border-[#12121214]'>
            <div className='nav-route flex px-[40px] border-b-[1px] border-[#12121214] gap-[7px] items-center py-[10px] text-[1.025vw] font-Zodiak-Regular text-[#121212bf]'>
                <Link to="/" >Home</Link>
                <i class="text-[6px] fa-solid fa-angle-right"></i>
                <Link to="/womenwatch" className='hover:underline '>Women's Watch Collection</Link>
            </div>
            ...
            <div className='container mx-auto py-[35px]'>
                <div className='gap-[10px] mx-auto flex flex-wrap justify-center'>
                    {data.womenwatch.map((item, ind) => {
                        return (
                            <div key={ind} className='main-wrp mb-[1.5%]'>
                                <div className='womenwatch-main watch-main'>
                                    <div className='relative rounded-lg overflow-hidden'>
                                        <div className='womenwatch-main watch-img w-full h-full'>
                                    ...
                                    <div className='watch-des-box-main p-[10px] pt-[18px]'>
