...
import bgimg from '../assets/img/Mens/bg-img.jpg';
import bgsub from '../assets/img/Mens/bg-sub-1.jpg';
import { Link } from 'react-router-dom';
function Menwatch() {
    return (
        <div className='menwatch border-t-[1px] border-[#12121214] watch-box'>
            <div className='nav-route flex px-[40px] gap-[7px] items-center py-[10px] text-[1.025vw] font-Zodiak-Regular text-[#121212bf]'>
                ...
                <Link className='hover:underline '>Men's Watches Showcase</Link>
            </div>
            ...
            <div className='container mx-auto py-[35px]'>
                <div className='gap-[10px] mx-auto flex flex-wrap justify-center'>
                    {data.menwatch.map((item, ind) => {
                        return (
                            <div key={ind} className='main-wrp mb-[1.5%]'>
                                <div className='menwatch-main watch-main'>
                                    <div className='relative rounded-lg overflow-hidden'>
                                        <div className='menwatch-img watch-img w-full h-full'>
